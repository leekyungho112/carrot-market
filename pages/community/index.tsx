      ...
      <div className="py-16 px-4 space-y-8">
        {[1, 2, 3, 4, 5].map((_, i) => (
          <div key={i} className="flex cursor-pointer flex-col items-start">
            ...
            <div className="mt-5 flex justify-between items-center w-full text-gray-500 text-sm font-medium">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
        ...
        <button className="fixed bottom-24 right-5 hover:bg-orange-600  transition-colors bg-orange-400 rounded-full shadow-xl p-4 text-white">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
